...
class Adapter_wishlist(private val wishlistList: ArrayList<Model_product>) : RecyclerView.Adapter<Adapter_wishlist.CartViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Adapter_wishlist.CartViewHolder {
